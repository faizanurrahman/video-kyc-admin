...
// Custom Dom Function
function traverseInheritanceOfDom(element: any) {
  let ownProperty = Object.getOwnPropertyNames(element);
  // console.log('CurrentElement Constructor Name: ', element.constructor.name);
  // console.log('Associated Property With Current Element: ', ownProperty);

  let prototype = Object.getPrototypeOf(element);
  let count = 1;
  while (prototype !== null) {
    ownProperty = Object.getOwnPropertyNames(prototype);
    // console.log('Prototype Level: ' + count + ' Constructor => ', prototype.constructor.name);
    // console.log('Prototype Level: ', count++ + ' Properties => ', ownProperty);
