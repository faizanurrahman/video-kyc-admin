...
class ScrollComponent {
  ...
  // NOTE: THIS METHOD WILL CALCULATE THE HEIGHT OF THE SCROLLABLE ELEMENT
    ...
    if (dependencies !== null) {
      ...
      if (elements && elements.length > 0) {
        for (let i = 0, len = elements.length; i < len; i++) {
          ...
          // NOTE: SET HEIGHT TO DEPENDENCIES TO MAKE SCROLLABLE HEIGHT CALCULATION CORRECT
