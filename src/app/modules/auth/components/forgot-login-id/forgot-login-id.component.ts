...
import { CountryMobileNumberRegex } from '../../../../features/loan-application-management/loan-application-steps/individual-form/country-code-regex';
...
import { RegistrationCaptchaComponent } from '../registration/registration-captcha/registration-captcha.component';
import { ValidateUserResponseModel } from './forgot-login-id.model';
import { ForgotLoginIdService } from './forgot-login-id.service';
enum ForgotLoginIdSteps {
  FindAccountStep,
  VerifyAccountStep,
  StatusStep,
}
@Component({
  ...
  styleUrls: ['./forgot-login-id.component.scss'],
  encapsulation: ViewEncapsulation.Emulated,
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [ForgotLoginIdService, ToastrService],
})
export class ForgotLoginIdComponent implements OnInit {
