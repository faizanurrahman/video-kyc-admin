...
export interface CreateFeedbackResponseBean {
  status: string;
  statusCode: string;
  statusDesc: string;
  instId: number;
...
export interface FeedbackData {
  FEEDBACK_MSG: string;
  FEEDBACK_CATEGORY: string;
  FEEDBACK_LIST: FeedbackListItem[];
  msg: string;
}
...
interface FeedbackListItem {
  ...
  updatedOn: string;
  status: string;
  mobeeFeedBackConversations: MobeeFeedBackConversation[];
  mobeeBankBranches: { [key: string]: string };
  feedbackReference: any;
}

interface MobeeFeedBackConversation {
  id: number;
  createdOn: string;
  status: string;
  msg: string;
...
export interface GetFeedbackResponseBean {
  status: string;
  statusCode: string;
  statusDesc: string;
  instId: number;
