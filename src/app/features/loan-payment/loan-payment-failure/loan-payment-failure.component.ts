...
@Component({
  selector: 'app-loan-payment-failure',
  templateUrl: './loan-payment-failure.component.html',
  styleUrls: ['./loan-payment-failure.component.scss'],
  encapsulation: ViewEncapsulation.Emulated,
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: true,
  imports: [InlineSVGModule, NgIf, RouterLink, LottieAnimationComponent, ClickableDirective],
})
export class LoanPaymentFailureComponent {
  loanAmount: any;
  requestId: any;
  ...
  constructor(private activatedRouter: ActivatedRoute, private storage: SecureStorageService) {
    ...
    // this.contractNumber = this.storage.get('payableContractNumber');
    // this.requestId = this.storage.get('payableRequestId');
