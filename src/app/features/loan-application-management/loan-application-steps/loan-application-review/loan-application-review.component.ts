...
import { LoanApplicationCompanyOrGroupModel } from '@features/loan-application-management/loan-application-steps/company-or-group-details/loan-application-company-or-group.interface';
import { NewLoanDocsModel } from '@lam/loan-application-steps/document-details-form-updated/document-model';
import { LoanApplicationDataModel } from '@lam/models/loan-application.model';
...
import { ReviewBasicDetailsComponent } from './components/review-basic-details/review-basic-details.component';
import { ReviewCompanyGroupDetailsComponent } from './components/review-company-group-details/review-company-group-details.component';
import { ReviewDocumentsDetailsComponent } from './components/review-documents-details/review-documents-details.component';
import { ReviewIndividualDetailsComponent } from './components/review-individual-details/review-individual-details.component';
import { ReviewServiceCenterDetailsComponent } from './components/review-service-center-details/review-service-center-details.component';
import { pdfMakeImagesUtils } from './pdfMakeImages.utils';
...
type LoanApplicationStep =
  ...
  | 'document_details';
@Component({
  selector: 'app-loan-application-review',
  templateUrl: './loan-application-review.component.html',
  styleUrls: ['./loan-application-review.component.scss'],
...
export class LoanApplicationReviewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  loanApplicationData: LoanApplicationDataModel;
  ...
  constructor(
    ...
    public loanApplicationReqiredField: LoanApplicationRequiredFieldService,
  ) {
    this.loanApplicationReqiredField.requiredFields$
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe((res: any[]) => {
        res.forEach((item: any) => {
          if (item.key === 'individual_details') {
            console.log('individual items got: ', item);
            this.errorIsVisible = true;
            this.individualRequiredFields = item?.value || [];
          } else if (item.key === 'company_details') {
            this.companyRequiredFields = item?.value || [];
            this.errorIsVisible = true;
          } else if (item.key === 'application_details') {
            this.applicationRequiredFields = item?.value || [];
            this.errorIsVisible = true;
          } else if (item.key === 'document_details') {
            this.documentRequiredFields = item?.value || [];
            this.errorIsVisible = true;
          }
        });
  ...
  public getPDFDocumentContent() {
    ...
    const size = individualDetails.length;
    ...
    documentContent.push(this.generateServiceDetailsTable(this.loanServiceCentre));
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {
              text: companyDetails.primaryContactEmailAddress || 'Not Applicable',
              style: 'tableValue',
              alignment: 'left',
            },
          ],
  ...
  private generateServiceDetailsTable(serviceCenter: LoanApplicationServiceDetailsModel) {
    return {
      table: {
        headerRow: 1,
        widths: ['*', '*'],
