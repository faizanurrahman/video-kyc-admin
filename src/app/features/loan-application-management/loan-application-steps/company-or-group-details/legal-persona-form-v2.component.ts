...
} from './loan-application-company-or-group.interface';
...
import { CapitalizeFirstTwoDirective } from './company-uin-mask.directive';
import { RequiredCompanyFields } from './required-field-for-company-details';

@Component({
  selector: 'app-company-or-group-details',
  templateUrl: './legal-persona-form-v2.component.html',
  styleUrls: ['./legal-persona-form-v2.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
...
export class LegalPersonaFormV2Component implements OnInit, OnChanges, OnDestroy {
  ...
  public async saveApplication() {
    ...
    return await lastValueFrom(this.loanApplicationService.saveLegalPersona(legalPersonaPayload))
